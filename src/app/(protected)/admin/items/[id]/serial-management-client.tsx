                    ...
                    {opt.colorClass && (
                      <span
                        className={cn(
                          ...
                          opt.colorClass.includes("emerald")
                            ? "bg-emerald-500"
                            : opt.colorClass.includes("blue")
                              ? "bg-blue-500"
                              : opt.colorClass.includes("amber")
                                ? "bg-amber-500"
                                : opt.colorClass.includes("red")
                                  ? "bg-red-500"
                                  : "bg-gray-400",
                        )}
                      />
...
export function SerialManagementClient({
  ...
  const [selectedWarehouseForNewSerial, setSelectedWarehouseForNewSerial] =
    useState("none");
  ...
  const handleAddSerial = async () => {
    ...
    const newSerialsArray = newSerial
      .split(/[\n,]+/)
      .map((s) => s.trim())
      .filter(Boolean);
        ...
        <div className="relative z-20 p-6">
            ...
            <button
              ...
              className={cn(
                ...
                mode === "single"
                  ...
                  : "bg-gray-50 text-gray-500 hover:bg-gray-100 dark:bg-zinc-950 dark:hover:bg-zinc-800 border border-transparent",
              )}
            >
              단건 연속 등록
            </button>
          ...
          <div className="flex flex-col gap-4">
            ...
            <div className="flex flex-col gap-3">
              <label className="text-xs font-black uppercase tracking-widest text-gray-500 dark:text-gray-400 px-1">
                시리얼 초기 배치 창고 <span className="text-red-500">*</span>
              </label>
        ...
        {initialSerials.length > 0 ? (
          ...
          <div className="text-center py-16 bg-gray-50 dark:bg-zinc-900/50 rounded-3xl border border-dashed border-black/5 dark:border-zinc-800">
            ...
            <p className="text-xs text-gray-500 font-medium">
              위 폼에서 바코드를 스캔하거나 타이핑하여 첫 자산을 등록하세요.
            </p>
          </div>
        )}
      </div>
