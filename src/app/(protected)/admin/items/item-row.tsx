      ...
      >
        ...
        <td className="px-4 py-3 whitespace-nowrap">
          <div className="text-xs text-gray-500 space-y-1 whitespace-nowrap">
            <div>
              생산: <span className="font-bold">{item.production_year}년</span>
            </div>
            {item.has_service_life ? (
              <div>
                수명: <span className="font-bold">{item.service_life}년</span>
              </div>
            ) : (
              <div>
                수명: <span className="font-bold text-gray-400">적용 안됨</span>
              </div>
            )}
          </div>
        </td>
        ...
        >
          <div className="flex items-center justify-end gap-1">
            ...
            <button
              ...
              className="text-red-500 hover:text-red-700 p-1.5 rounded-lg hover:bg-red-50 dark:hover:bg-red-900/20 transition-colors active:scale-90 disabled:opacity-50"
            >
              ...
              <div className="px-12 py-6 border-b border-blue-100/50 dark:border-blue-900/20 shadow-inner flex flex-col items-center justify-center bg-gray-50/50 dark:bg-zinc-950/50">
                <div className="text-center mb-4">
                  <span className="text-sm font-black text-gray-900 dark:text-white block">
                    총 {itemSpecificSerials.length}개의 시리얼 넘버가 등록되어
                    있습니다
                  </span>
                  <span className="text-[10px] text-gray-400 font-bold uppercase tracking-widest whitespace-nowrap mt-1 block">
                    개별 자산 관리를 위해 상세 페이지로 이동하세요
                  </span>
                </div>
