...
export default async function AdminTransactionsPage() {
  ...
  return (
    <div className="space-y-8">
      ...
      <div className="border border-black/5 rounded-xl sm:rounded-2xl bg-white shadow-sm dark:bg-zinc-900 dark:border-zinc-800 overflow-hidden">
        <h3 className="text-base sm:text-lg font-black p-3 sm:p-6 tracking-tight border-b border-gray-50 dark:border-zinc-800">
          최근 이력
        </h3>
        <div className="overflow-x-auto">
          <table className="w-full text-left text-xs sm:text-sm whitespace-nowrap">
            <thead className="bg-gray-50 text-gray-700 dark:bg-zinc-800 dark:text-gray-300 uppercase font-semibold text-[10px] sm:text-xs">
              <tr>
                <th className="px-3 sm:px-4 py-3">물품명</th>
                <th className="px-3 sm:px-4 py-3">유형/수량</th>
                <th className="px-3 sm:px-4 py-3">사용자</th>
                <th className="px-3 sm:px-4 py-3">창고 / 사유</th>
                <th className="px-3 sm:px-4 py-3">일시</th>
              </tr>
            </thead>
